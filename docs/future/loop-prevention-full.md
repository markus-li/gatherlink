# Loop Prevention Full Design Notes

## Purpose

Multihop overlays require loop prevention.

Without loop prevention, self-healing route changes can create traffic loops.
...
Route identity for loop prevention belongs to authenticated topology/control
state. Secure packets must not expose plaintext routing labels.
