...
The SOCKS5 helper supports TCP CONNECT. SOCKS5 UDP ASSOCIATE is deferred.

## Ownership

The SOCKS5 helper is Python-owned.
...
Gatherlink should not implement SOCKS5 parsing in Rust. Rust acceleration is
deferred until profiling shows Python proxy I/O or SOCKS parsing is the
bottleneck.
