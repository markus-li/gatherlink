# Relay Fabric Full Design Notes
...
It is active helper work for discovery and health. Secure relay-session
forwarding is specified in `docs/protocol/relay-session-lifecycle.md` and
`docs/protocol/protocol.md`; relay fabric provides candidates and metadata, not plaintext
routing decisions.
