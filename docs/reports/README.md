...
| File | Status | Purpose |
| --- | --- | --- |
| `v0.9-roadmap.md` | closed release roadmap | V0.9 implementation order and acceptance checklist; reusable process guidance lives in [`docs/operations/release-development-process.md`](../operations/release-development-process.md). |
...
| `v0.9.3-roadmap.md` | active release roadmap | V0.9.3 adaptive performance and real-world operation roadmap after the v0.9.2 baseline. |
...
- Do not keep active release gates only in reports; link or promote them to
  [`docs/operations/v0.9-release-checklist.md`](../operations/v0.9-release-checklist.md) or the relevant release checklist.
