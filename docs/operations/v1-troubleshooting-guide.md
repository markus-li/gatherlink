...
For current v1 follow-up state, direct DNS upstreams run now. Gatherlink-tunnel
DNS upstream execution is tracked in `docs/reports/v1-code-audit-followups.md`
until implemented and VM-proven.
