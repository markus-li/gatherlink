...
- Debian is the tested v0.9 platform; see `docs/user/README.md`.
- Security and routing posture are defined in `docs/protocol/security.md` and
  `docs/protocol/relay-session-lifecycle.md`.
- Runtime/control boundaries are defined in `docs/architecture/architecture-contract.md`.
