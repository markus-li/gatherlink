"""Feature extraction from rolling metrics for future local advisor/anomaly detection logic.
...
# File-specific TODO:
# - Implement helpers.policy_advisor.features without introducing dataplane hot-path dependencies.
