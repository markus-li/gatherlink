"""Expose an optional streamed browser session to the user through the Gatherlink UI.
...
# File-specific TODO:
# - Implement helpers.captive_portal.vnc_gateway without introducing dataplane hot-path dependencies.
