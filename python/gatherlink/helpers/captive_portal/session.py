"""Captive portal login session lifecycle, TTL, state, cleanup, and safety limits.
...
# File-specific TODO:
# - Implement helpers.captive_portal.session without introducing dataplane hot-path dependencies.
