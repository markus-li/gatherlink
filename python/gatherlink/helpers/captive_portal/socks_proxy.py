"""Temporary SOCKS5 proxy pinned to one captive WAN source/interface.
...
# File-specific TODO:
# - Implement helpers.captive_portal.socks_proxy without introducing dataplane hot-path dependencies.
