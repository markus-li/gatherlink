"""Generate temporary PAC files and browser instructions for captive portal login sessions.
...
# File-specific TODO:
# - Implement helpers.captive_portal.pac without introducing dataplane hot-path dependencies.
