"""Retest DNS, HTTP, HTTPS, UDP, QUIC, WSS, and bootstrap connectivity after captive portal login.
...
# File-specific TODO:
# - Implement helpers.captive_portal.retest without introducing dataplane hot-path dependencies.
