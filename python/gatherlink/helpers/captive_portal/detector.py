"""Detect captive portal behavior on a physical WAN link without making the core transport depend on it.
...
# File-specific TODO:
# - Implement helpers.captive_portal.detector without introducing dataplane hot-path dependencies.
